    ...
    justify-content: right;">
                @if (Route::has('login'))
                    <nav class="navbar bg-body-tertiary">
                        @auth
                            <a href="{{ url('/home') }}" class="font-semibold text-gray-600  dark:text-gray-400    ">Configuraciones</a>
            ...
            <main class="content">
                    <div class="container">
                        ...
                        <div class="row justify-content-center">
                            ...
                            @if(auth()->user()->hasRole(['denuncia', 'seguimiento']))       
                            <div class="col">    
        ...
        <footer class="footer">
                                        ...
                                        <div class="left">
                                            <a href="https://github.com/sponsors/taylorotwell" class="text-secondary">
                                                SOFCRUZ 2023
                                            </a>
                                        </div>
